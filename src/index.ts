  ...
  api = {
    ...
    updateLoanConsentAndCustomFieldsObsolete: (
      ...
      this.request<string, UnprocessableEntity>({
        ...
        body: data,
        secure: true,
        type: ContentType.JsonPatchPatchPatchPatch,
        format: "json",
        ...params,
      }),
     ...
     */
    createLoanv3: (data: LoanApplicationRequest, params: RequestParams = {}) =>
     ...
     * @response `404` `ProblemDetails` Not Found
     */
    completeBorrowerApplication: (
      loanId: string,
      borrowerId: string,
      params: RequestParams = {},
    ) =>
      this.request<void, ProblemDetails>({
        path: `/api/loans/${loanId}/borrowers/${borrowerId}/complete`,
        method: "POST",
        secure: true,
        ...params,
      }),
