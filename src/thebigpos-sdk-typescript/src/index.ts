...
export type RefinanceExistingType =
  | "Conventional"
  | "ARM"
  | "Jumbo"
  | "FHA"
...
export type PropertyOccupancyType =
  | "PrimaryResidence"
  | "SecondaryResidence"
  | "Investment"
...
export type BorrowerLanguagePreference =
  | "English"
  | "Chinese"
  | "Korean"
  | "Tagalog"
...
export type BorrowerCitizenshipStatus =
  | "USCitizen"
...
> extends HttpClient<SecurityDataType> {
  ...
  api = {
     ...
     */
    getLoanByIdV3: (id: string, params: RequestParams = {}) =>
      this.request<LoanV3, ServiceError>({
