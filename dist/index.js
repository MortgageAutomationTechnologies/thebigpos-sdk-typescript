...
export class Api extends HttpClient {
    constructor() {
        ...
        this.api = {
             ...
             * @response `200` `Loan` Success
             */
            updateLoan: (loanId, data, params = {}) => this.request(Object.assign({ path: `/api/loans/${loanId}`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
