...
export class Api extends HttpClient {
    constructor() {
        ...
        this.api = {
             ...
             * @response `422` `UnprocessableEntity` Client Error
             */
            updateLoanConsentAndCustomFieldsObsolete: (loanId, data, params = {}) => this.request(Object.assign({ path: `/api/los/loan/application/${loanId}`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
             * @tags LegacyLoan
             ...
             * @response `422` `UnprocessableEntity` Client Error
             */
            updateLoanCustomFields: (loanId, data, params = {}) => this.request(Object.assign({ path: `/api/los/loan/application/${loanId}/custom-fields`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
             * @tags LegacyLoan
             ...
             * @response `422` `UnprocessableEntity` Client Error
             */
            updateLoanConsent: (loanId, data, params = {}) => this.request(Object.assign({ path: `/api/los/loan/application/${loanId}/consent`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
             * @tags LegacyLoan
             ...
             * @response `200` `ListingFile` Success
             */
            updateListingFiles: (listingId, data, params = {}) => this.request(Object.assign({ path: `/api/listings/${listingId}/files`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
             * @tags ListingFiles
             ...
             * @response `200` `(ListingPhoto)[]` Success
             */
            updateListingPhotos: (listingId, data, params = {}) => this.request(Object.assign({ path: `/api/listings/${listingId}/photos`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
             * @tags ListingPhotos
             ...
             * @response `200` `Loan` Success
             */
            updateLoan: (loanId, data, params = {}) => this.request(Object.assign({ path: `/api/loans/${loanId}`, method: "PATCH", body: data, secure: true, type: ContentType.JsonPatchPatchPatchPatchPatch, format: "json" }, params)),
            /**
             * No description
             *
